...
import { wordBuilderExercise } from "./exercises/builder.js";
...
const toolbarBtnBuilder = document.querySelector(".exercises__builder");
...
const contentBuilder = document.querySelector(".builder");
